...
export default function RoundTrip() {
    return (
        <>
            <div className="round-trip bg-white p-10 shadow-lg rounded-xl rounded-tl-none  absolute top-0 left-0 w-full">
                <div className="top-form flex">
                    ...
                    <div className="input-group flex w-2/5 border border-gray-300 rounded ml-2">
                        ...
                        <div className="input w-full  pr-3 pl-14 relative border-l border-gray-300">
                ...
                <div className="bottom-form lg:pt-10 pt-5 flex justify-between items-center flex-wrap">
                    <div className="left-side w-full lg:w-1/2">
                        <a href="/searchflightround" className="text-lg font-semibold text-blue-500 flex items-center lg:justify-start justify-center lg:mb-0 mb-5"> <img src="/images/more.svg" alt="icon" /> More options: Class of travel, Airline preference</a>
                    </div>
                    ...
                    <div className="select-group flex">
                        ...
                        <a className="text-white bg-gradient-to-r from-blue-500 to-purple-600 hover:from-purple-600 hover:to-blue-500 px-7 py-2 rounded-full font-semibold ml-4" href="/searchflightround">SEARCH</a>
                    </div>
                </div>
            </div>
        </>
