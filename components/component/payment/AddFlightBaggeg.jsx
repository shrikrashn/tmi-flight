...
export default function AddFlightBaggeg() {
    return (
        <>
            <div className="add-flight-baggage mx-auto w-full fixed top-0 left-0 right-0 bg-black bg-opacity-40 h-full hidden">
                <div className="modal-inner bg-white mx-auto w-8/12 shadow rounded mt-20">
                    ...
                    <div className="middle px-8 flex pb-20">
                        <div className="left w-1/4 mt-3">
                            ...
                            <ul className="mt-5">
                                <li>
                                    <a className="text-base bg-blue-500 rounded px-5 py-2 text-white font-normal hover:bg-blue-600" href="">Mumbai → New Delhi</a>
                                </li>
                            </ul>
                        </div>
                        <div className="right w-3/4 pl-8">
                            <div className="repeat flex justify-between items-center py-3 border-b">
                                <label className="text-gray-700">50kg</label>
                            ...
                            <div className="repeat flex justify-between items-center py-3 border-b">
                                <label className="text-gray-700">200kg</label>
                                <div className="flex items-center px-4 justify-between">
                                    <span className="text-blue-500 font-semibold">₹425</span>
                                    <div className="groups w-36 select-number rounded-full shadow h-8 flex items-center px-4 justify-between hover:shadow-md ml-10">
                                        <svg className="w-6 cursor-pointer text-gray-600" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div className="repeat flex justify-between items-center py-3 border-b">
                                <label className="text-gray-700">100kg</label>
                                <div className="flex items-center px-4 justify-between">
                                    <span className="text-blue-500 font-semibold">₹425</span>
                                    <div className="groups w-36 select-number rounded-full shadow h-8 flex items-center px-4 justify-between hover:shadow-md ml-10">
                                        <svg className="w-6 cursor-pointer text-gray-600" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div className="repeat flex justify-between items-center py-3 border-b">
                                <label className="text-gray-700">5kg</label>
                                <div className="flex items-center px-4 justify-between">
                                    <span className="text-blue-500 font-semibold">₹425</span>
                                    <div className="groups w-36 select-number rounded-full shadow h-8 flex items-center px-4 justify-between hover:shadow-md ml-10">
                                        <svg className="w-6 cursor-pointer text-gray-600" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="bottom w-full px-8 py-5 border-t flex justify-between items-center">
                        <div className="bottom-left">
                            <button className="text-green-600 uppercase" type="reset">Remove all baggage</button>
                        </div>
